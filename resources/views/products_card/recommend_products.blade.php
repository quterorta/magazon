<div class="products-container">
    ...
    <p class="recommended-products-header container-header">Produse recomandate</p>

    <div class="recommended-products-grid products-grid">
        @foreach ($recommend_products as $product)
            <div class="recommended-product-card product-card">
    ...
    <a href="{{ route('all-recommended-products') }}" class="show-all-products-button show-all-recommended-products-button">Toate recomandările</a>
