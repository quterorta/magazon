...
@section('title')
"{{ $shop->title }}" | Добавить товар
@endsection

@section('main-content-block')

<h1 class="shop_page__header">Добавить товар</h1>
<div class="shop_page__breadcrumbs">
    <ul>
        ...
        <li class="shop_page__breadcrumbs__link_separator">/</li>
        <li class="shop_page__breadcrumbs__link active"><a>Добавить товар</a></li>
    </ul>
</div>
@if (session('success'))
...
<div class="shop_page__form">
    <form action="{{ route('store-shop-product', $shop->id) }}" method="POST" class="shop_page__shop_form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" name="alias" id="product_alias" class="form-control" required placeholder="Введите slug товара">
        </div>
        ...
        <div class="shop_page__shop_form__select_image_block">
            ...
            <div class="shop_page__shop_form__select_image_block__grid">
                <div class="shop_page__shop_form_select_image_block__select_image_input">
                    <label for="product_image_cover">Обложка товара</label>
                    <input type="file" name="image_cover" id="product_image_cover" required>
                </div>
                <div class="shop_page__shop_form_select_image_block__select_image_input">
        ...
        <div class="form-group d-grid">
            <button type="submit" class="btn btn-success shop_page__shop_form__save_btn">Добавить товар</button>
        </div>
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_cover').parent().css("padding", "10px");
    ...
    function readURL1(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_1').parent().css("padding", "10px");
    ...
    function readURL2(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_2').parent().css("padding", "10px");
    ...
    function readURL3(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_3').parent().css("padding", "10px");
    ...
    function readURL4(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_4').parent().css("padding", "10px");
    ...
    function readURL5(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('#product_image_5').parent().css("padding", "10px");
