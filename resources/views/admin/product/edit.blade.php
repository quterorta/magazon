...
@section('title')
AdminPanel | Edit product "{{ $product->title }}"
@endsection

@section('main-admin-content')
    <h1>Изменить товар "{{ $product->title }}"</h1>
    ...
    <div>
        <form action="{{ route('product.update', $product->id) }}" method="POST" class="admin-create-items-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <select name="sub_category_id" id="subcategory_id" class="form-select">
                    ...
                    <option value="{{ $subcategory->id }}"@if ($subcategory->id == $product->sub_category->id) selected @endif>{{ $subcategory->title }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="alias" id="product_alias" class="form-control" required placeholder="Введите алиас товара" value="{{ $product->alias }}">
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ Storage::url($product->image_cover) }}" id="image_cover" alt="Обложка товара" style="display: block; height: 100px;">
                <input type="file" name="image_cover" id="product_image_cover" class="form-control" placeholder="Выберете изображение для обложки товара">
            </div>

            <div class="form-group">
                <label for="product_image_1">Изображение товара</label>
                @if (null !== $product->image_1)
                <img src="{{ Storage::url($product->image_1) }}" id="image_1" alt="Изображение товара" style="display: block; height: 100px;">
                @endif
            ...
            <div class="form-group">
                ...
                <img src="{{ Storage::url($product->image_2) }}" id="image_2" alt="Изображение товара" style="display: block; height: 100px;">
                @endif
            ...
            <div class="form-group">
                ...
                <img src="{{ Storage::url($product->image_3) }}" id="image_3" alt="Изображение товара" style="display: block; height: 100px;">
                @endif
            ...
            <div class="form-group">
                ...
                <img src="{{ Storage::url($product->image_4) }}" id="image_4" alt="Изображение товара" style="display: block; height: 100px;">
                @endif
            ...
            <div class="form-group">
                ...
                @if (null !== $product->image_5)
                <img src="{{ Storage::url($product->image_5) }}" id="image_5" alt="Изображение товара" style="display: block; height: 100px;">
                @endif
            ...
            <div class="form-group">
                ...
                <select name="shop_id" id="shop_id" class="form-select">
                    ...
                    <option value={{ $shop->id }} @if ($shop->id == $product->shop_id) selected @endif>{{ $shop->title }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group" id="product_new_price_block">
                ...
                <input type="text" name="new_price" id="product_new_price" class="form-control" placeholder="Введите новую стоимость товара" @if (null !== $product->new_price) value="{{ $product->new_price}}" @endif>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="moderate" id="product_moderate" class="form-select">
                    <option value=0 @if ($product->moderate == 0) selected @endif>Нет</option>
                    <option value=1 @if ($product->moderate == 1) selected @endif>Да</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="recommended" id="product_recommended" class="form-select">
                    <option value=0 @if ($product->recommended == 0) selected @endif>Нет</option>
                    <option value=1 @if ($product->recommended == 1) selected @endif>Да</option>
                </select>
            </div>
